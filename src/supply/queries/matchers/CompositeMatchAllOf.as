package supply.queries.matchers {
	 ...
	 * @author jamieowen
	 */
	public class CompositeMatchAllOf implements ICompositeMatcher
	{
		private var _matches:Vector.<IMatcher>;
		
		public function CompositeMatchAllOf( matches:Vector.<IMatcher> )
		{
			_matches 			= matches;
		}
		...
		{
			return new CompositeMatchAllOf(_matches);
		}
	}
}
